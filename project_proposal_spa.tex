...
La Antártida es el mayor desierto sobre el planeta, las heladas temperaturas, los vientos arrazadores y la extremadamente baja humedad del ambiente, convierten al continente blanco en el lugar más inhóspito del planeta, durante el invierno es prácticamente imposible para un investigador humano sobrevivir en esas condiciones, sin mencionar el alto costo que esto implica.


El objetivo de Octanis es construir robots autonomos de  bajo presupuesto que se encarguen de explorar, recopilar datos y analisar muestras y enviar los resultados en tiempo real, robots que pueden ser adaptados y equipados para cualquier tarea y para cualquier tipo de ambiente. Esto facilitaría en gran manera el trabajo de los investigadores, y permitiría reducir el presupuesto necesario para el trabajo de campo.

Octanis I el primer robot de nuestra organización, se encarga de medir el pH de las muestras de hielo y nieve que recopilará, será completamente autónomo y tránsmitirá los datos obtenidos en tiempo real a nuestra pagina web y a las bases cientificas que se desee, la energía que utilizará será subministrada por paneles solares y una pequeña batería, los datos serán tránsmitidos por la red de satélites de Iridium, los objetivos específicos  de la misión serán presentados acontinuación:
